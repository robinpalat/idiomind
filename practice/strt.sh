...
if [[ -n "$1" ]]; then
    ...
    learned=$(< ./a.l); info1="* "
    info="<small>$(gettext "Learned")</small> <span color='#757575'><b><big>$learned </big></b></span>   <small>$(gettext "Easy")</small> <span color='#757575'><b><big>$easys </big></b></span>   <small>$(gettext "Learning")</small> <span color='#757575'><b><big>$learning </big></b></span>   <small>$(gettext "Difficult")</small> <span color='#757575'><b><big>$hards </big></b></span>\n"
    elif [ ${1} = 7 ]; then
    learned=$(< ./b.l); info2="* "
    info="<small>$(gettext "Learned")</small> <span color='#757575'><b><big>$learned </big></b></span>   <small>$(gettext "Easy")</small> <span color='#757575'><b><big>$easys </big></b></span>   <small>$(gettext "Learning")</small> <span color='#757575'><b><big>$learning </big></b></span>   <small>$(gettext "Difficult")</small> <span color='#757575'><b><big>$hards </big></b></span>\n"
    elif [ ${1} = 8 ]; then
